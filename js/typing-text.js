...
function typingEffect() {
    const contactTexts = shuffleArray(['Save Environment in single click!!', 'Want to help our society?', 'Want to talk about an idea?', 'Lets do something together!!', 'Do you need help in waste management?']);
